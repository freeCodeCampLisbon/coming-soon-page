<template>
  <div class="container">
    ...
    <ul>
      ...
      <li>
        <p>
          ...
          this Agreement) refers to freecodecamp Lisbon, R. do Instituto
          Virgílio Machado 14.
        </p>
      </li>
      <li>
      ...
      <li>
        <p>
          <strong>Website</strong> refers to freecodecamp Lisbon, accessible
          from
          <a
            href="https://www.freecodecamplisbon.org"
            rel="external nofollow noopener"
            target="_blank"
            >https://www.freecodecamplisbon.org</a
          >
        </p>
      </li>
      <li>
    ...
    <ul>
      <li>
        By email:
        <a class="link" href="mailto:info@freecodecamplisbon.org"
